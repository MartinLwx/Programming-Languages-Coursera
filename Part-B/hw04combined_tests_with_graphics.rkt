...
;; Returns a graphics window you can pass as the first argument to place-repeatedly
(define (open-window)
...
; Uses the first n values produced by stream
; Each stream element must be a pair:
;      (integer between 0 ~ 5 . the name of an image file)
; Every pause seconds, the next stream value is retrieved
; positions:
;  0 1 2
;  3 4 5
